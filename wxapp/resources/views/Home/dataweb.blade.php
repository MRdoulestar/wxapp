        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    ...
                    @if(session('level') == 1)
                        <li><a href="dataweb" class="active"><i class="lnr lnr-code"></i> <span>数据导出</span></a></li>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-offset-5 col-md-5">
                                    <a href="excel/export" class="btn btn-lg btn-primary">导出审核结果</a>
                                </div>
                            </div>
                        </div>
                    </div>
