                ...
                <nav>
                    ...
                    @elseif(session('level') == 2)
                       <li><a href="commitweb" class=""><i class="lnr lnr-code"></i> <span>提交审核</span></a></li>
                        ...
                        <li><a href="historyweb" class="active"><i class="lnr lnr-chart-bars"></i> <span>历史记录</span></a></li>
                    @endif
                    </ul>
                </nav>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-headline">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="navbar-form navbar-left" method="post" action="historyweb">
